...
## this file is edited from https://github.com/EdjeElectronics/TensorFlow-Object-Detection-on-the-Raspberry-Pi#6-detect-objects
...
IM_WIDTH = 320
IM_HEIGHT = 240
ip_camera_url = "http://frp.xsourse.cc:8081/"
...
### USB webcam ###
    ...
    while(True):
        ...
        # print(boxes[0][0])
        bbox = boxes[0][0]
        bbx_width = (bbox[2] - bbox[0]) * IM_WIDTH
